...
<h1  style={{padding: "0rem 0 2rem 0", fontSize: "1.5rem" , fontWeight: "bold",
...
<h1 style={{padding: "0rem 0 1rem 0", fontSize: "1.5rem" ,
    ...
    }}>Komponenšu diagrammas ir struktūras diagrammas, kas parāda sistēmas komponentes un to savstarpējās attiecības.</p>
...
<h1 style={{padding: "2rem 0 1rem 0", fontSize: "1.5rem" ,
    }}>Viņas mērķis/kam to izmantot?</h1>

    <p style={{padding: "0rem 0 2rem 0",
    }}>Komponentu diagrammas tiek izmantotas, lai viegli pārskatītu lielas un sarežģītas sistēmas no augstāka līmeņa, kā arī lai sadalītu lielus projektus mazākās, pārskatāmākās daļās, tādējādi atvieglojot orientēšanos un sapratni par projekta struktūru.</p>
...
<h1 style={{padding: "3rem 0 1rem 0", fontSize: "1.5rem" ,
    }}>Piemērs ar dabas elementiem</h1>
<img
